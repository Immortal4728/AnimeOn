...
import { CrtGlitchContainer } from "@/components/crt-glitch-container";
      ...
      <main className="scanlines relative min-h-screen bg-[#07090e] text-foreground flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="relative isolate hidden lg:flex lg:w-1/2 flex-col justify-between p-12 overflow-hidden border-r border-border/30">
          ...
          <div className="z-10 pt-16 space-y-4">
            ...
            <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold uppercase tracking-[0.14em] sm:tracking-[0.16em] text-foreground drop-shadow-[0_0_25px_var(--neon)] leading-tight max-w-xl">
              <span className="crt-glitch crt-text-glitch" data-text="One quiet shelf for everything worth remembering.">
                One quiet shelf for everything worth remembering.
              </span>
            </h2>
            <p className="text-xs sm:text-base uppercase tracking-[0.2em] text-muted-foreground max-w-md leading-relaxed">
        ...
        <div className="relative flex min-h-screen lg:min-h-0 flex-1 flex-col items-center justify-center p-4 sm:p-8 lg:p-16 bg-[#07090e]">
          ...
          <div className="relative w-full max-w-md space-y-6 sm:space-y-8 text-center rounded-3xl border border-border/40 bg-card/40 p-6 sm:p-12 backdrop-blur-2xl shadow-[0_0_50px_rgba(0,0,0,0.8)] mt-12 lg:mt-0 crt-card-glitch">
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 font-display text-2xl sm:text-3xl uppercase tracking-[0.22em] text-foreground drop-shadow-[0_0_20px_var(--neon)]">
                <span className="h-2 w-2 rounded-full bg-neon animate-ping" />
                <span className="crt-glitch crt-text-glitch" data-text="ANIME ON">
                  ANIME ON
                </span>
              </div>
              <h1 className="font-display text-3xl sm:text-5xl lg:text-6xl font-extrabold uppercase tracking-[0.14em] sm:tracking-[0.16em] text-foreground drop-shadow-[0_0_25px_var(--neon)]">
                <span className="crt-glitch crt-text-glitch" data-text="WELCOME BACK">
                  WELCOME BACK
                </span>
              </h1>
              <p className="text-xs sm:text-base uppercase tracking-[0.2em] text-muted-foreground font-medium">
            ...
            <div className="space-y-3 pt-2 border-t border-border/20">
              <p className="text-xs sm:text-sm uppercase tracking-[0.2em] text-muted-foreground/90 font-mono">
                One account · Private Firestore storage
              </p>
              <div className="flex flex-wrap justify-center gap-2 text-[11px] sm:text-xs uppercase tracking-[0.18em] text-muted-foreground/70 font-mono">
