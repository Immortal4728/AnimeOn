  ...
  return (
    <CrtGlitchContainer className="min-h-screen bg-[#07090e] text-foreground">
      <main id="top" className="scanlines min-h-screen bg-[#07090e] text-foreground overflow-x-hidden">
        ...
        <header
          className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-4 sm:px-6 lg:px-12 crt-nav-glitch ${
            isScrolled
        ...
        <section className="relative isolate flex min-h-screen flex-col items-center justify-center px-6 text-center pt-16">
          ...
          <div className="max-w-5xl space-y-4 sm:space-y-6">
            <h1 className="font-display text-5xl sm:text-7xl lg:text-8xl xl:text-[9.5rem] font-extrabold uppercase tracking-[0.12em] sm:tracking-[0.16em] text-foreground drop-shadow-[0_0_35px_var(--neon)]">
              <span className="crt-glitch crt-text-glitch" data-text="ANIME ON">
                ANIME ON
              </span>
            </h1>
            <p className="max-w-3xl mx-auto text-sm sm:text-xl lg:text-2xl font-extrabold uppercase tracking-[0.2em] sm:tracking-[0.25em] text-foreground/90 leading-relaxed">
              <span className="crt-glitch crt-text-glitch" data-text="EVERYTHING YOU MEAN TO WATCH. ONE QUIET SHELF.">
                EVERYTHING YOU MEAN TO WATCH. ONE QUIET SHELF.
              </span>
            </p>
            <p className="text-xs sm:text-base uppercase tracking-[0.18em] sm:tracking-[0.2em] text-muted-foreground pt-1 sm:pt-2 font-mono">
